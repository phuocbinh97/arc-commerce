    ...
    <div className="min-h-screen bg-bg flex items-center justify-center p-6">
      <div className="grid grid-cols-[1fr_360px] gap-5 w-full max-w-4xl items-start">
        ...
        <div className="bg-surface border border-white/8 rounded-xl shadow-lg">
          <div className="p-6">
            ...
            <div className="mb-4 p-3.5 bg-surface2 border border-white/8 rounded-lg flex items-center gap-3">
              <div className="w-10 h-10 rounded-lg bg-accent grid place-items-center text-white font-bold text-lg">{merchantName.charAt(0)}</div>
              <div>
                <div className="text-[11px] font-semibold text-muted uppercase">Merchant</div>
                <div className="font-semibold text-ink">{merchantName}</div>
              </div>
            ...
            <div className="grid grid-cols-2 gap-3 mb-3">
              <div>
                ...
                <input value={amount} readOnly className="w-full border border-white/8 rounded-lg px-3 py-2.5 text-sm bg-surface2 text-ink" />
              </div>
              <div>
        ...
        <div className="bg-surface border border-white/8 rounded-xl shadow-lg p-6">
          ...
          <div className="text-5xl font-black tracking-tight mb-1 text-ink">${amount} <span className="text-xl text-muted font-semibold">USDC</span></div>
